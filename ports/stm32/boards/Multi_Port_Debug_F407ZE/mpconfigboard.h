...
#define MICROPY_HW_RTH_PHY_MII (1)
...
/*RGMII*/
#define MICROPY_HW_ETH_RGMII_TX_CLK    (pin_C3)
#define MICROPY_HW_ETH_RGMII_TX_EN     (pin_B11)
#define MICROPY_HW_ETH_RGMII_TXD0      (pin_B12)
#define MICROPY_HW_ETH_RGMII_TXD1      (pin_B13)
#define MICROPY_HW_ETH_RGMII_TXD2      (pin_C2)
#define MICROPY_HW_ETH_RGMII_TXD3      (pin_E2)
#define MICROPY_HW_ETH_RGMII_RX_CLK    (pin_A1)
#define MICROPY_HW_ETH_RGMII_RX_DV     (pin_A7)
#define MICROPY_HW_ETH_RGMII_RXD0      (pin_C4)
#define MICROPY_HW_ETH_RGMII_RXD1      (pin_C5)
#define MICROPY_HW_ETH_RGMII_RXD2      (pin_B0)
#define MICROPY_HW_ETH_RGMII_RXD3      (pin_B1)
#define MICROPY_HW_ETH_RGMII_RX_ER     (pin_B10)
#define MICROPY_HW_ETH_RGMII_CRS       (pin_A0)
#define MICROPY_HW_ETH_RGMII_COL       (pin_A3)
